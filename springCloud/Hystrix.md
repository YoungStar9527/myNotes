...
sempahore技术可以用来限流和削峰，但是不能用来对调用延迟的服务进行timeout和隔离
...
流程图：https://www.processon.com/view/link/612b3b4e5653bb2d6d14ab2b

思维导图：https://www.processon.com/view/link/612ba9047d9c081c752868e8
...
8 **toBlocking()方法，首先触发的就是Func0的call()方法（return Observable.defer(new Func0<Observable<R>>() { 最后返回的Func0的call方法）**
